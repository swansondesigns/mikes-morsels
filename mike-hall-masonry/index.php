...
<?php endif; ?>
    <nav id="nav-below" class="navigation" role="navigation">
        <div class="view-previous"><?php next_posts_link( __( '<span>&larr;</span> Older', 'pinbin' ) ) ?></div>
        <div class="view-next"><?php previous_posts_link( __( 'Newer <span>&rarr;</span>', 'pinbin' ) ) ?> </div>
    </nav> 
<?php get_footer(); ?>
